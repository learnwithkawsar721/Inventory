                ...
                <div class="card-body">
                    <form action="{{ route('customer.update',$customer->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{ $customer->email }}" class="form-control" id="email" placeholder="Customer email">
                            @error('email')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" value="{{ $customer->phone }}" class="form-control" id="phone" placeholder="Customer phone">
                            @error('phone')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="city" value="{{ $customer->city }}" class="form-control" id="city" placeholder="Customer city">
                            @error('city')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="shopname" value="{{ $customer->shopname }}" class="form-control" id="shopname"
                                placeholder="Customer shopname">

                        </div>
                        <div class="form-group">
                            <label for="account_holder">Customer account_holder</label>
                            <input type="text" name="account_holder" value="{{ $customer->account_holder }}" class="form-control" id="account_holder"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="account_number" value="{{ $customer->account_number }}" class="form-control" id="account_number"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_name" value="{{ $customer->bank_name }}" class="form-control" id="bank_name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_branch" value="{{ $customer->bank_branch }}" class="form-control" id="bank_branch"
