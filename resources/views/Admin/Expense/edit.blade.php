        ...
        <div class="col-xl-6 m-auto">
            <div class="card">
                <div class="card-header bg-primary ">
                    <h3 class="card-title text-white">Edit Expenses</h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('expenses.update',$expenses->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="details" value="{{ $expenses->details }}" id="details" class="form-control"
                                placeholder="Expenses details">

                        </div>
                        <div class="form-group">
                            <label for="amount">Amount</label>
                            <input type="number" step="0.0001" value="{{ $expenses->amount }}" name="amount" id="amount" class="form-control"
                                placeholder="amount">
