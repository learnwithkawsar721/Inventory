...
@section('dashboard')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h1 style="text-align: center">Total: {{ $today->sum('amount') }} Taka</h1>
                <div class="card-header">
                    <h1 class="card-title">Today Expenses <a href="{{ route('expenses.create') }}" class="btn btn-sm btn-primary">add New</a></h1>
                </div>
                <div class="card-body">
