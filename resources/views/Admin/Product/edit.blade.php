                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_code" value="{{ $product->product_code }}" id="product_code" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select name="sup_id" id="sup_id" class="form-control">
                                @foreach ($suppliers as $item)
                                    <option {{ ($product->sup_id == $item->id)?'selected':'' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="godaun" value="{{ $product->godaun }}" id="godaun" class="form-control" placeholder="Product godaun">

                        </div>
                        <div class="form-group">
                            <label for="product_route">Product Route</label>
                            <input type="text" name="product_route" value="{{ $product->product_route }}" id="product_route" class="form-control"
                                placeholder="Product Route">

                        </div>
                        <div class="form-group">
                            <label for="buy_day">Buying Day</label>
                            <input type="date" name="buy_day" value="{{ $product->buy_day }}" id="buy_day" class="form-control" placeholder="">

                        </div>
                        <div class="form-group">
                            <label for="expire_day">Expire Day</label>
                            <input type="date" name="expire_day" value="{{ $product->expire_day }}" id="expire_day" class="form-control" placeholder="">

                        </div>
                        <div class="form-group">
                            <label for="buy_price">Buying Price</label>
                            <input type="number" step="0.0001" name="buy_price" value="{{ $product->buy_price }}" id="buy_price" class="form-control"
                                placeholder="">

                        </div>
                        <div class="form-group">
                            <label for="selling_price">Selling Price</label>
                            <input type="number" step="0.0001" value="{{ $product->selling_price }}" name="selling_price" id="selling_price" class="form-control"
                                placeholder="">
